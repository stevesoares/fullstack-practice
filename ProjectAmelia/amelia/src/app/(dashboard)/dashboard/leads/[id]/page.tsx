  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-[var(--font-cormorant)] text-3xl">Lead: {lead.clientName}</h1>
        <span className="text-xs rounded-full bg-muted px-2 py-1">{lead.status}</span>
      </div>

      <section className="rounded-2xl border border-border bg-background p-6 space-y-2">
      ...
      <section className="rounded-2xl border border-border bg-background p-6">
        ...
        <ul className="list-disc pl-6 text-sm text-muted-foreground space-y-1">
          <li>Send intro email</li>
          <li>Confirm availability on calendar</li>
          <li>Draft contract and tentative invoice</li>
        </ul>
      </section>
    </main>
  );
